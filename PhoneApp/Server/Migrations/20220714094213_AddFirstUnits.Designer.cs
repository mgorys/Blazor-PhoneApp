...
namespace PhoneApp.Server.Migrations
{
    ...
    [Migration("20220714094213_AddFirstUnits")]
    partial class AddFirstUnits
    {
            ...
            modelBuilder.Entity("PhoneApp.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Featured = true,
                            ImageUrl = "https://www.x-kom.pl/p/681200-smartfon-telefon-apple-iphone-13-pro-max-1tb-graphite.html",
